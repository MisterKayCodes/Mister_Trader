...
def get_main_menu():
    ...
    Maps to: Accounts, Trades, Strategies, Plans, Stats, Export, Psychology, Voice Notes, Media, Activity.
    """
    keyboard = [
        [KeyboardButton(text="📁 Accounts"), KeyboardButton(text="📊 Active Trades")],
        [KeyboardButton(text="📋 Strategies"), KeyboardButton(text="📅 Plans")],
        [KeyboardButton(text="📈 Stats"), KeyboardButton(text="📥 Export")],
